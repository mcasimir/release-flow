...
var Finish = (_dec = (0, _Phase2.Step)(), _dec2 = (0, _Phase2.Step)(), _dec3 = (0, _Phase2.Step)(), _dec4 = (0, _Phase2.Step)(), _dec5 = (0, _Phase2.Step)(), (_class = function (_Phase) {
  ...
  _createClass(Finish, [{
    ...
    value: function getReleaseInfo(release) {
      ...
      release.name = release.branchName.slice(0, release.options.releaseBranchPrefix);
  ...
  return Finish;
}(_Phase3.default), (_applyDecoratedDescriptor(_class.prototype, 'getReleaseInfo', [_dec], Object.getOwnPropertyDescriptor(_class.prototype, 'getReleaseInfo'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'validate', [_dec2], Object.getOwnPropertyDescriptor(_class.prototype, 'validate'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'mergeToProduction', [_dec3], Object.getOwnPropertyDescriptor(_class.prototype, 'mergeToProduction'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'tagProduction', [_dec4], Object.getOwnPropertyDescriptor(_class.prototype, 'tagProduction'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'mergeBackToDevelopment', [_dec5], Object.getOwnPropertyDescriptor(_class.prototype, 'mergeBackToDevelopment'), _class.prototype)), _class));
