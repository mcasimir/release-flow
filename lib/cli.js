...
}).locale('en').usage('Usage: $0 <command> [options]').command('start', 'Starts a release').command('publish', 'Push a release').command('finish', 'Finish a release').demand(1).strict().help().version();
