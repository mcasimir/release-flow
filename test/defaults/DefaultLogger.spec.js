...
describe("DefaultLogger", function () {
  ...
  describe("log", function () {
    ...
    it("logs error in red", function () {
      ...
      deepEqual(logger.console.log.args[0], [red(bold("error:") + " msg")]);
    });
    ...
    it("logs warn in yellow", function () {
      ...
      deepEqual(logger.console.log.args[0], [yellow(bold("warn:") + " msg")]);
    });
  });
  ...
  it("logs info in white", function () {
    ...
    deepEqual(logger.console.log.args[0], [white(bold("info:") + " msg")]);
  });
  ...
  it("logs debug in gray", function () {
    ...
    deepEqual(logger.console.log.args[0], [gray(bold("debug:") + " msg")]);
  });
});
